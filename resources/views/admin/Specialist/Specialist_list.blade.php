...
@section('content')
    ...
    <div class="modal fade" id="specialistModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" class="form" id="newSpecialistForm" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="modal-footer">
                    ...
                    <a onclick="saveUpdateData('add','#specialistModal','newSpecialistForm','#SpecialistTable','store-Specialist')"
    ...
    <div class="pagetitle">
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="text-align: right;">
                <a data-bs-toggle="modal" data-bs-target="#specialistModal"
                    onclick="openaddmodel('Add New Specialist','0','store-Specialist','#newSpecialistForm','#specialistModalLabel','#specialistModal')"
                    class="btn btn-sm new-bloodtype btn-primary">
                    <i class="bi bi-plus-lg"></i>
                </a>
                <a onclick="deletedata('2','0','delete-Specialist','#SpecialistTable')"
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-striped" id="SpecialistTable">
                            <thead>
                                <tr>
...
@section('page-js')
    <script type="text/javascript">
        var url = "{{ route('loadSpecialist-data') }}";
